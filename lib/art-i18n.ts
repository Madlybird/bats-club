...
export const ART_I18N: Record<ArtLocale, ArtStrings> = {
  en: {
    ...
    sold_out_note: "Sold out — may be reprinted, check back.",
    shipping_note: "Ships worldwide · rolled in a tube or flat with a board · 8–15 working days",
    spec_type: "Type",
    spec_series: "Series",
    spec_year: "Year",
    spec_size: "Size",
  ...
  ru: {
    ...
    sold_out_note: "Продано — возможна допечатка, загляните позже.",
    shipping_note: "Доставка по миру · в тубусе или плоско с подложкой · 8–15 рабочих дней",
    spec_type: "Тип",
    spec_series: "Серия",
    spec_year: "Год",
    spec_size: "Размер",
  ...
  jp: {
    ...
    in_stock: "在庫 {n} 点",
    last_one: "残り1点",
    sold_out_note: "売り切れ — 再販の可能性あり。またご覧ください。",
    shipping_note: "海外発送 · 筒または板入れ平梱包 · 8〜15営業日",
    spec_type: "種類",
    spec_series: "シリーズ",
    spec_year: "年",
    spec_size: "サイズ",
