...
export default async function ListingDetailPageJp(props: Props) {
  ...
  const jsonLd = buildListingJsonLd(listing, figure, displayImages, "jp")
  const breadcrumbJsonLd = buildBreadcrumbJsonLd([
    { name: "Bats Club", url: "https://batsclub.com/jp" },
    { name: dict.shop_heading, url: "https://batsclub.com/jp/shop" },
    { name: figure?.name, url: `https://batsclub.com/jp/shop/${listing.id}` },
  ])
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
              ...
              <div className="space-y-6">
                ...
                <div className="rounded-2xl border border-white/[0.06] p-4" style={{ background: "rgba(255,255,255,0.02)" }}>
                  ...
                  <Link href={`/jp/figures/${figure?.slug || figure?.id}`} className="text-sm font-medium transition-colors hover:opacity-80" style={{ color: "#ff2d78" }}>
