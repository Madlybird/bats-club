  ...
  return (
    <InfoPageShell title="Условия использования">
      ...
      <section>
        ...
        <p className="text-white/60 text-sm leading-relaxed">
          Раздел «Арт» продаёт оригинальные работы SINBIOX — постеры, принты, открытки, стикеры, холсты и зины, созданные художником и продающиеся как новые.
        </p>
        <ul className="text-white/60 text-sm leading-relaxed list-disc pl-5 space-y-2 mt-3">
          <li><span className="text-white font-semibold">Состояние.</span> Весь арт продаётся как новый. Незначительные отличия в цвете, подрезке или отделке печатных работ — свойство материала, а не брак.</li>
          <li><span className="text-white font-semibold">Наличие и цены.</span> Наличие отображается в реальном времени. Цены указаны в долларах США и фиксируются в момент оформления заказа.</li>
          <li><span className="text-white font-semibold">Доставка.</span> Арт отправляется в поддерживаемые регионы с трек-номером. Ориентировочный срок доставки — 14–28 рабочих дней. Заказы в неподдерживаемые регионы возвращаются в полном объёме.</li>
          <li><span className="text-white font-semibold">Таможенные пошлины и налоги.</span> Международные заказы могут облагаться таможенными пошлинами и импортными налогами страны назначения; эти расходы несёт получатель. Если посылка возвращена нам из-за неоплаченных таможенных сборов, стоимость первоначальной доставки не возвращается.</li>
          <li><span className="text-white font-semibold">Работы с возрастными ограничениями.</span> Некоторые работы содержат художественную обнажённую натуру или suggestive-темы и помечены 18+. Покупая помеченную работу, вы подтверждаете, что достигли совершеннолетия по законам вашей юрисдикции.</li>
          <li><span className="text-white font-semibold">Интеллектуальная собственность.</span> Покупка работы передаёт право собственности только на один физический экземпляр. Все авторские права, личные неимущественные права и иные права на интеллектуальную собственность в работе и её изображении остаются у SINBIOX. Вы не вправе воспроизводить, копировать, сканировать, фотографировать для распространения, печатать, публиковать, распространять, продавать репродукции, публично или коммерчески демонстрировать работу, а также создавать производные произведения на её основе — полностью или частично. Лицензия на работу не предоставляется. Работу нельзя изменять или представлять способом, искажающим замысел художника.</li>
          <li><span className="text-white font-semibold">Возвраты.</span> Возврат принимается только при повреждении в доставке или производственном дефекте, в течение 14 дней после получения, с видео распаковки. Возврат «передумал» и обмен не принимаются. Цифровые файлы не подлежат возврату после выдачи ссылки на скачивание.</li>
          <li><span className="text-white font-semibold">Цифровые файлы.</span> Цифровая покупка — это файл PDF, доступ к которому даётся по ссылке на почту после оплаты и действует 7 дней. Разрешено личное использование, включая печать для себя; перепродажа, распространение и коммерческое использование файла запрещены.</li>
          <li><span className="text-white font-semibold">Оплата и применимое право.</span> Оплата обрабатывается через Stripe в долларах США. Настоящие условия регулируются правом Специального административного района Гонконг.</li>
        </ul>
      </section>
