    ...
    <InfoPageShell title="Условия использования">
      ...
      <section>
        ...
        <ul className="text-white/60 text-sm leading-relaxed list-disc pl-5 space-y-2 mt-3">
          ...
          <li><span className="text-white font-semibold">Возвраты.</span> Возврат принимается только при повреждении в доставке или производственном дефекте, в течение 14 дней после получения, с видео распаковки. Возврат «передумал» и обмен не принимаются.</li>
