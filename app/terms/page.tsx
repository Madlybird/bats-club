    ...
    <InfoPageShell title="Terms of Service">
      ...
      <section>
        ...
        <ul className="text-white/60 text-sm leading-relaxed list-disc pl-5 space-y-2 mt-3">
          ...
          <li><span className="text-white font-semibold">Returns.</span> Returns are accepted only for transit damage or a manufacturing defect, within 14 days of delivery, with an unboxing video. Change-of-mind returns and exchanges are not accepted. Digital downloads are non-refundable once the download link has been issued.</li>
          <li><span className="text-white font-semibold">Digital downloads.</span> A digital purchase is a PDF file, delivered by a download link emailed after payment and valid for 7 days. It grants personal use, including printing for yourself; you may not resell, redistribute or use the file commercially.</li>
